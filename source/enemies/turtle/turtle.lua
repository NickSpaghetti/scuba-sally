...
function Turtle:init(x,y,travelRange)
    local turtleImage = gfx.image.new('enemies/turtle/turtle')
    assert(turtleImage, "Failed to load image of turtle")
    Turtle.super.init(self,x,y,turtleImage,EnemeyMovementPath.Horzontal,1)
    self:setCenter(0,0)
...
function Turtle:update()
    ...
    --Turtle should only move up and down between a specific screenHeight
